    ...
    <div class="cart-product clearfix">
      <table>
        ...
        <tr>
          ...
          <td class="td-product"><img src="/static/1.jpg" width="98" height="98">
        ...
        <tr>
          ...
          <td class="td-product"><img src="/static/2.png" width="98" height="98">
            <div class="product-info">
              <h6>【斯文】甘油&nbsp;|&nbsp;丙三醇</h6>
              <p>品牌：韩国skc&nbsp;&nbsp;产地：韩国</p>
              <p>规格/纯度:99.7%&nbsp;&nbsp;起定量：215千克</p>
...
<style scoped>
  ...
  .page-shopping-cart .check-span {
    ...
    width: 24px;
    height: 20px;
    background: url("../assets/shopCar.png") no-repeat 0 0; }
  .page-shopping-cart .check-span.check-true {
    background: url("../assets/shopCar.png") no-repeat 0 -22px; }
  ...
  .page-shopping-cart .cart-product table .product-num .num-reduce span {
    background: url("../assets/shopCar.png") no-repeat -40px -22px;
    display: block;
    width: 6px;
    height: 2px;
    margin: 13px auto 0 auto; }
  .page-shopping-cart .cart-product table .product-num .num-add span {
    background: url("../assets/shopCar.png") no-repeat -60px -22px;
    display: block;
    width: 8px;
    height: 8px;
  ...
  .page-shopping-cart .cart-product-info .delect-product span {
    ...
    width: 13px;
    height: 15px;
    background: url("../assets/shopCar.png") no-repeat -60px 0; }
  ...
  .page-shopping-cart .cart-product-info .keep-shopping span {
    ...
    width: 15px;
    height: 15px;
    background: url("../assets/shopCar.png") no-repeat -40px 0; }
  ...
  .page-shopping-cart .cart-worder .choose-worder span {
    ...
    width: 22px;
    height: 22px;
    background: url("../assets/shopCar.png") no-repeat -92px 0; }
  ...
  .choose-worker-box .box-title a {
    ...
    width: 10px;
    height: 10px;
    background: url("../assets/shopCar.png") no-repeat -80px 0; }
  .choose-worker-box .box-title a:hover {
    background: url("../assets/shopCar.png") no-repeat -80px -22px; }
